...
public class NQueens {
  ...
  public List<List<Integer>> nqueens(int n) {
    ...
    // where the queen on row i position;
  ...
  public List<List<Integer>> nqueensII(int n) {
    ...
    // record on which diagonal lines there is already queen
  ...
  private boolean valid(int n, int row, int column, boolean[] usedColumns, boolean[] usedDiagonals,
  ...
  private void mark(int n, int row, int column, boolean[] usedColumns, boolean[] usedDiagonals,
      boolean[] usedRevDiagonals) {
  ...
  private void unMark(int n, int row, int column, boolean[] usedColumns, boolean[] usedDiagonals,
      boolean[] usedRevDiagonals) {
