...
public class CombinationsOfCoins {
  ...
  private void helper(int remain, int[] coins, int index, List<Integer> cur, List<List<Integer>> result) {
    /**
     * terminate condition: NOTICE: this can also be done at index == coins.length
     * where all the coins have been picked. But a probably better one is at a
     * previous level to reduce the number of unnecessary branches in the DFS.
     */
