...
public class StringReplace {
	...
	private String replaceShorter(char[] input, String s, String t) {
		// We reuse the input char array since the number of characters
		// needed is less.
	...
	private String replaceLonger(char[] input, String s, String t) {
		...
		// is "in place", usually you can assume you are given a long enough char array
		// already, and the original input string resides on part of the char array
		// starting from index 0. In this solution, we actually allocate a larger array on demand,
