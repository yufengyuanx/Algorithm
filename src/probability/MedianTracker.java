...
public class MedianTracker {
  ...
  public MedianTracker() {
    // we care about the smaller number of the larger half and
  ...
  public void read(int value) {
    ...
    // values read,
    // or size(smallerHalf) == size(largerHalf) + 1, when
  ...
  public Double median() {
    ...
    // if the number for values read is odd, the largest one in
