...
public class LCAI {
	 ...
	 *  My understand
	 *  
	 *  for each node, tell your parent if you find any of target node
	 *     if you find two node, return yourself.
	 *     if you find one of them, return that one.
	 *     if you find nothing, tell your parent "null" means find nothing.
	 * 
	 */
