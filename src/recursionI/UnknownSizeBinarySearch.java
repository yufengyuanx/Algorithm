 ...
 * 1. The dictionary is an unknown sized sorted array, it only provides get(int
 * index) functionality, if the index asked for is out of right bound, it will
 * return null; 2. The elements in the dictionary are all Integers.
 */
