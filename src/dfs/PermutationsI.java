...
public class PermutationsI {
  ...
  /**
   * choose the character to be at the position of index all the already chosen
   * positions are (0, index - 1) all the candidate characters can be at the
   * position index are in the subarray of (index, array.length - 1)
   */
